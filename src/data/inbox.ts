...
export const THREADS: Thread[] = [
  {
    ...
    country: 'Ghana',
    flag: '🇬🇭',
    subject: 'Re: Screening plant availability — 20t class',
    received: '2h ago',
    channel: 'campaign',
    body: 'Following your mailer last week — do you still have the Powerscreen Chieftain screeners in Rotterdam? We need one under 8,000 hours for a road aggregate contract starting September. Budget is €95-120K CIF Tema. Please send full spec and photos.',
    handling: 'auto-replied',
    intent: 'Buying inquiry · specific model class · in-budget',
    confidence: 96,
    extracted: [
      { label: 'Category', value: 'Screener, 20t class' },
      { label: 'Hours ceiling', value: '8,000 h' },
      { label: 'Budget', value: '€95-120K CIF' },
      { label: 'Destination', value: 'Tema, Ghana' },
      { label: 'Needed by', value: 'September' },
    ],
    matchId: 'OM-4471',
    reply: 'Hello Kwame — yes, we have a 2016 Powerscreen Chieftain 2100X at 4,200 hours in Rotterdam, inspection score 91/100. Landed Tema at €112,000 including RoRo freight, which sits inside your budget. Full spec sheet and 6 photos attached. Two further Chieftain 2100X units are available if you need a set.',
    repliedIn: '3 min',
  },
  {
    id: 'THR-5509',
    ...
    country: 'Nigeria',
    flag: '🇳🇬',
    subject: 'Cold planer requirement — federal road contract',
    received: '5h ago',
    channel: 'campaign',
    ...
    confidence: 92,
    extracted: [
      { label: 'Category', value: 'Cold Planer, 2m class' },
      { label: 'Quantity', value: '2 units' },
      { label: 'Budget', value: '€85-110K (pair)' },
      { label: 'Destination', value: 'Apapa, Nigeria' },
    ],
    matchId: 'OM-4120',
    reply: 'Hello Chidi — we hold a 2013 Wirtgen W 200 in Rotterdam (12,900 h, inspection 86) and a 2016 Vögele Super 1800-3i paver listed in Utrecht (6,800 h, inspection 90). Spec sheets and photos attached for both. The W 200 alone lands Apapa at €196,000; I have asked our desk to price the pair against your ceiling and come back to you today.',
    repliedIn: '6 min',
  },
  {
    id: 'THR-5504',
  ...
  },
  {
    ...
    country: 'Kenya',
    flag: '🇰🇪',
    subject: 'Tandem roller for quarry haul roads',
    received: 'Yesterday',
    channel: 'website',
    ...
    confidence: 90,
    extracted: [
      { label: 'Category', value: 'Roller, 12-13t' },
      { label: 'Application', value: 'Quarry / aggregate' },
      { label: 'Budget', value: '€60-72K' },
      { label: 'Destination', value: 'Mombasa, Kenya' },
    ],
    matchId: 'OM-4060',
    reply: 'Hello Grace — the Hamm HD+ 120i VV (2014, 10,100 h, inspection 88) is listed for Bertoli Groundworks in Verona. €69,800 landed Mombasa. Spec sheet and photos attached; drum configuration is confirmed as vibratory-vibratory.',
    repliedIn: '4 min',
  },
  {
    id: 'THR-5496',
  ...
  },
  {
    ...
    country: 'Peru',
    flag: '🇵🇪',
    subject: 'Jaw crusher, mining specification',
    received: '3d ago',
    channel: 'website',
    body: 'Buscamos una trituradora de mandíbulas para faena minera. Presupuesto €190-225K, entrega Callao. ¿Qué tienen disponible?',
    handling: 'auto-replied',
    intent: 'Buying inquiry · Spanish · mining application',
    confidence: 85,
    extracted: [
      { label: 'Language', value: 'Spanish — replied in kind' },
      { label: 'Category', value: 'Crusher, jaw' },
      { label: 'Application', value: 'Mining' },
      { label: 'Budget', value: '€190-225K' },
  ...
  },
  {
    ...
    country: 'Tanzania',
    flag: '🇹🇿',
    subject: 'Cheapest screener you have',
    received: '4d ago',
    channel: 'campaign',
    body: 'What is the cheapest screening plant you can land in Dar es Salaam? Hours are not important to us, condition just needs to be working. Around €55-70K.',
    handling: 'drafted',
    intent: 'Buying inquiry · price-led · hours flexible',
    confidence: 79,
    extracted: [
      { label: 'Category', value: 'Screener, budget' },
      { label: 'Budget', value: '€30-36K' },
      { label: 'Hours', value: 'Not a constraint' },
      { label: 'Destination', value: 'Dar es Salaam, Tanzania' },
    ],
    matchId: 'OM-4351',
    reply: 'Hello Joseph — the closest fit is a 2011 Terex Finlay 883+, 13,400 hours, listed for Kelly Plant Hire in Cork and currently in inspection. Indicative €66,500 landed Dar es Salaam. It is a high-hour machine, so I would want the inspection signed off before confirming — I will come back to you the moment it clears.',
  },
  {
    id: 'THR-5468',
    from: 'Fatima Bello',
  ...
  },
  {
    ...
    country: 'Nigeria',
    flag: '🇳🇬',
    subject: 'Spare parts for Chieftain 2100X',
    received: '5d ago',
    channel: 'website',
    body: 'Do you sell conveyor belts and screen mesh for the Chieftain 2100X? We run four of them.',
    handling: 'auto-replied',
    ...
    extracted: [
      ...
      { label: 'Onward value', value: 'Runs 4× Chieftain — future buyer' },
    ],
    reply: 'Hello Tunde — we trade complete machines rather than parts, so I cannot help directly on screen mesh. I have added you to our Chieftain stock alerts, since you run a fleet of four and we move these regularly. If you ever want to replace rather than repair, we usually have several available.',
    repliedIn: '3 min',
  },
  {
    id: 'THR-5452',
  ...
  },
  {
    ...
    country: 'Ghana',
    flag: '🇬🇭',
    subject: 'Screening plant availability (resent)',
    received: '6d ago',
    channel: 'campaign',
    body: 'Following your mailer last week — do you still have the Powerscreen Chieftain screeners in Rotterdam?...',
    handling: 'filtered',
